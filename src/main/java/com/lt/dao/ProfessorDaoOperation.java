...
public class ProfessorDaoOperation implements ProfessorDaoInterface {
	...
	public List<Course> getCoursesByProfessor(String profId) {
		...
		try {
			PreparedStatement statement = connection
					.prepareStatement(SQLQueriesConstant.GET_COURSES);
			...
			while (results.next()) {
				courseList.add(new Course(results.getString("courseCode"),
						results.getString("courseName"), results
								.getString("professorId"), results
								.getInt("seats")));
			}
	...
	public List<EnrolledStudent> getEnrolledStudents(String courseId) {
		...
		try {
			PreparedStatement statement = connection
					.prepareStatement(SQLQueriesConstant.GET_ENROLLED_STUDENTS);
			...
			while (results.next()) {
				...
				// int studentId)
				enrolledStudents.add(new EnrolledStudent(results
						.getString("courseCode"), results
						.getString("courseName"), results
						.getString("studentId")));
			}
		} catch (SQLException e) {
			logger.error(e.getMessage());
	...
	public Boolean addGrade(String studentId, String courseCode, String grade) {
		...
		try {
			PreparedStatement statement = connection
					.prepareStatement(SQLQueriesConstant.ADD_GRADE);
	...
	public String getProfessorById(String profId) {
		...
		try {
			PreparedStatement statement = connection
					.prepareStatement(SQLQueriesConstant.GET_PROF_NAME);
